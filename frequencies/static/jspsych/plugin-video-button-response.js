var jsPsychVideoButtonResponse = (function (jspsych) {
  ...
  class VideoButtonResponsePlugin {
      ...
      `);
          ...
          // setup stimulus
          var video_html = "<div class='row'><div class='col-12 col-md-8 col-lg-6 mx-auto'><div class='ratio ratio-4x3'>";
          ...
          video_html += '<div id="jspsych-video-button-response-btngroup" class="row">';
          for (var i = 0; i < trial.choices.length; i++) {
              var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
              video_html +=
                  '<div class="col px-0"><div class="jspsych-video-button-response-button" id="jspsych-video-button-response-button-' +
                      i +
                      '" data-choice="' +
                      i +
                      '">' +
          ...
          const end_trial = () => {
              ...
              display_element
                  .querySelector("#jspsych-video-button-response-stimulus")
                  .pause();
              display_element.querySelector("#jspsych-video-button-response-stimulus").onended = () => { };
